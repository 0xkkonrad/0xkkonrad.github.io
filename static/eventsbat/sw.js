const SHELL_CACHE = 'eventsbat-shell-v2';
const DATA_CACHE = 'eventsbat-data-v2';
const PREFIX = 'eventsbat-';
const SCOPE_PATH = '/eventsbat/';
const SHELL_ASSETS = [
  SCOPE_PATH,
  ...
  `${SCOPE_PATH}icons/bat-maskable-512.png`,
    "/eventsbat/assets/index-BYmXQOi0.js",
  "/eventsbat/assets/index-BwZdqqv1.css",
];
